...
class PlainResNetClassifier(BaseModule):
    ...
    def __init__(self, num_cls=10, weights_init='ImageNet', num_layers=18, init_feat_only=True, parallel=0):
    ...
    def load(self, init_path, feat_only=False):
        ...
        if feat_only:
            ...
            init_weights = OrderedDict({k.replace('module.', ''): init_weights[k]
                                        for k in init_weights})
